...
- Modify: `src/value.rs` (add `pub const TAG_ARRAY: u64 = 6;`)

**Interfaces:**
- Produces: `TokenKind::List` (lexer), `TAG_ARRAY: u64 = 6` (value.rs) — both consumed by Task 2 (parser) and Task 3 (codegen).
